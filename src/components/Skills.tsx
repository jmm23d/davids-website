      ...
      <div className="section-container">
        <div className="text-center mb-16">
          ...
          <p className="section-subtitle mx-auto">
            Specialized tools, technologies, and professional capabilities that
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {skillCategories.map((category, categoryIndex) => (
            <div
              key={categoryIndex}
              className="p-6 rounded-xl border-glow bg-card text-card-foreground animate-on-scroll opacity-0"
        ...
        {/* Technology badges */}
        <div className="mt-16">
          <h3 className="text-xl font-bold mb-6 text-center text-foreground animate-on-scroll opacity-0">
            Tools & Technologies
          </h3>
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {[
              ...
              <span
                key={index}
                className="px-4 py-2 bg-muted text-foreground rounded-full text-sm font-medium animate-on-scroll opacity-0 hover-transform"
